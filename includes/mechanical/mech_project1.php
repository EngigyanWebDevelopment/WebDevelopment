...
<head>
    ...
    <title>Industrial Projects in Mechanical Engineering</title>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item" id="">
                    <a class="nav-link" href="#">
                        <div class="link-nav" data-toggle="modal" data-target="#register"> <span> <i class="fa fa-user" aria-hidden="true"></i> </span> Hello, User</div>
                    </a>
                </li>
            </ul>
