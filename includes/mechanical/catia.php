...
<body>
    ...
    <div class="jumbotron" id="head">
        <div class="row2" style="margin-left: 0px !important">
            <div class="col1" id="c_img"><img src="../../images/catia.png" alt="SolodWorks" class="img-fluid" id="course_img" style="margin-top: 20px !important;"></div>
            <div class="col2" id="c_cont">
                <div class="row"><h1>CATIA: Complete Course</h1></div>
