...
<body>
    ...
    <div class="jumbotron" id="head">
        <div class="row2" style="margin-left: 0px !important">
            <div class="col1" id="c_img"><img src="../../images/java.png" alt="Python" class="img-fluid" id="course_img"></div>
            <div class="col2" id="c_cont">
                <div class="row"><h1>JAVA: Complete Course</h1></div>
                <div class="row" style="text-align: justify;"><h5><b>JAVA </b> a top contender in the race of programming languages that a programmer should consider learning: Lots of job opportunities.</h5></div>
            </div>
            <div class="col3">
