...
<body>
    ...
    <div class="jumbotron" id="head">
        <div class="row2" style="margin-left: 0px !important">
            <div class="col1" id="c_img"><img src="../../images/linux.png" alt="Linux" class="img-fluid" id="course_img"></div>
            <div class="col2" id="c_cont">
                <div class="row"><h1>Linux - "The Choice of Security Experts"</h1></div>
        ...
        <div class="container" id="what-will-learn">
            ...
            <ul style="list-style-type:none">
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> What is LINUX and why we use it
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Scope and Future of Linux and Open Source
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Setup and Installation Linux on the Pocket
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Basic Commands and System Configuration
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Networks Setup and Tuned
                </li>
                <div id="accordion">
                    <div class="collap">
                        ...
                        <div id="collapseOne" class="collapse" data-parent="#accordion">
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Remote Controlling of System
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Virtual Network Computing to easy manage Server
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Security and Hacking Tips and Tricks
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Concepts of Hard Drive and RAM
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Client-Server model
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Server configuration FTP,SSH,HTTP and many more
                            </li>
                        </div>
                    </div>
                </div>
            ...
            <ul style="list-style-type: none; color: #565656;">
                <li id="includes-content">
                    <span id="includes-gliphs"><i class="fa fa-terminal"></i></span> Complete Practical Sessions with Interactive Question & Answer session
                </li>
                <li id="includes-content">
                    <span id="includes-gliphs"><i class="fa fa-file-text-o"></i></span> Learn & Interact from Red Hat certified Architect & Red Hat Certified Cloud Administrator
                </li>
                <li id="includes-content">
                    <span id="includes-gliphs"><i class="fa fa-server" aria-hidden="true"></i></span> Hands on Demonstrations of Latest Computing Techniques & Tools.
                </li>
                <li id="includes-content">
