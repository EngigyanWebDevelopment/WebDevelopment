...
<body>
    ...
    <div class="jumbotron" id="head">
        <div class="row2" style="margin-left: 0px !important">
            <div class="col1" id="c_img"><img src="../../images/robotics.jpg" alt="C++" class="mx-auto d-block" id="course_img"></div>
            <div class="col2" id="c_cont">
                <div class="row"><h1>Robotics</h1></div>
                <div class="row"><h5>Do you know what a microcontroller is?  Have you got an idea to make a robot or a device but don’t know where to start? In this course we are going to accompany you in your journey from novice to a professional robots developer</h5></div>  
            </div>
            <div class="col3">
    ...
    <div class="container-fluid">
        <div class="container" id="what-will-learn">
            ...
            <ul style="list-style-type:none">
                ...
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> MICRO-CONTROLLERS
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> MECHANISMS
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> ELECTRONIC COMPONENTS
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> ELECTRONIC MODULES AND MORE
                </li>
                <div id="accordion">
                    <div class="collap">
                        ...
                        <div id="collapseOne" class="collapse" data-parent="#accordion">
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Learning to Program
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Introduction to Sensors
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Ultrasound Sensor Module
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> IR Sensor Module
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> More Programming and More Electronics
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Communication 
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Bluetooth Module
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> WiFi MODULE
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Datalogging
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Making efficient CODES 
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Making a four wheel Drive robot
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Making a three wheel Drive robot
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Motion Based on Inputs from sensors
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Using a PS
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Actuators
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Raspberry PI
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> IDE NOOBS
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> PYTHON for Raspberry Pi
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> CONCLUSION
                            </li>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="accordion2">
                        <div class="collap">
                            ...
                            <div id="collapseTwo" class="collapse" data-parent="#accordion2">
                                ...
                                <div class="question">
                                    <div class="row">
                                        Q5. What are the full form and purpose of IOREF and AREF pins on arduino?
                                    </div>
                                    <div class="">
                                        <textarea name="" id="" cols="100" rows="3" style="max-width: 100%; max-height: 10%;"></textarea>
                                    </div>
    ...
    <div class="overlay" id="overlay">
        ...
        <div class="overlaycontainer">
            <video id="video" controls>
                    <source src="../../videos/ENGIGYAN Robotics class 06.mp4" type="video/mp4">
