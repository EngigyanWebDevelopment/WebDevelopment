...
<head>
    ...
    <title>Course: Cloud Computing</title>
...
<body>
    ...
    <div class="jumbotron" id="head">
        <div class="row2" style="margin-left: 0px !important">
            <div class="col1" id="c_img"><img src="../../images/cloudcomp.jpg" alt="C++" class="mx-auto d-block" id="course_img"></div>
            <div class="col2" id="c_cont">
                <div class="row"><h1>Cloud Computing</h1></div>
                <div class="row"><h5><b>Cloud Computing</b> is an emerging technology through which an increasing number of IT services are delivered over the Internet. The result is that organizations can reduce costs and be more flexible, more mobile, and scalable while improving
                    their quality of service.</h5></div>  
            </div>
            <div class="col3">
                ...
                <div class="row" id="price"><small><strike>Rs. 2200</strike></small> Rs. 1800</div>
                <div class="row" id="buttons">
                    <button class="btn btn-primary">Pay Now</button> &nbsp;
                    <button class="btn btn-outline-danger">Start Free Demo</button>
                </div>
                <div class="row" id="buttons">
                    <button class="btn btn-success">Goto Webinar</button>
                    <div style="border: 1px solid grey; border-radius: 3px; padding: 5px;">Google Classroom</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container" id="what-will-learn">
            ...
            <ul style="list-style-type:none">
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Build your OWN Cloud Computing Data Center
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Understanding the Components and Infrastructure of the cloud
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Understanding the Benefits and Future of cloud computing
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Deployment of IaaS, SaaS, Storage As-a-Service
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Assessing Security Risks
                </li>
                <div id="accordion">
                    <div class="collap">
                        ...
                        <div id="collapseOne" class="collapse" data-parent="#accordion">
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Obtaining Cloud Storage and Protocols
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Glusterfs Storage (Base Idea Behind Storage Management in BigData)
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Working with Major Cloud Service Providers
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Private and Public Cloud Management
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Private : OpenStack Deployment
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Public : AWS (Amazon)
                            </li>
                        </div>
                    </div>
                </div>
