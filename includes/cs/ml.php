...
<body>
    ...
    <div class="jumbotron" id="head">
        <div class="row2" style="margin-left: 0px !important">
            <div class="col1" id="c_img"><img src="../../images/ml.jpg" alt="C++" class="mx-auto d-block" id="course_img"></div>
            <div class="col2" id="c_cont">
                <div class="row"><h1>Machine Learning</h1></div>
                <div class="row"><h5>Roles like Chief Data Scientist & Chief Analytics Officers have emerged to ensure that analytical insights drive business strategies – Forbes
Businesses Will Need One Million Data Scientists by 2020 – Kdnuggets &nbsp; In this module, you will learn the concept of Machine Learning and it’s types.</h5></div>  
            </div>
            <div class="col3">
        ...
        <div class="container" id="what-will-learn">
            ...
            <ul style="list-style-type:none">
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Python Revision (numpy, Pandas, scikit learn, matplotlib)
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> What is Machine Learning?
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Machine Learning Use-Cases
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Machine Learning Process Flow
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Machine Learning Categories
                </li>
                <div id="accordion">
                    <div class="collap">
                        ...
                        <div id="collapseOne" class="collapse" data-parent="#accordion">
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Linear regression
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Gradient descent
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Linear Regression – Using Boston Dataset
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Illustrate Supervised Learning Algorithms
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> List the categories of Machine Learning
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Necessary Machine Learning Python libraries
                            </li>
                        </div>
                    </div>
                </div>
