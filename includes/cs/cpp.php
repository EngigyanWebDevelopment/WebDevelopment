    ...
    <div class="jumbotron" id="head">
        <div class="row2" style="margin-left: 0px !important">
            ...
            <div class="col2" id="c_cont">
                <div class="row"><h1>C++: Complete Course</h1></div>
                <div class="row"><h5><b>C++ </b> a top contender in the race of programming languages that a programmer should consider learning to clear the basics of programming.</h5></div>  
            </div>
            <div class="col3">
        ...
        <div class="container" id="what-will-learn">
            ...
            <ul style="list-style-type:none">
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Installation of C++ Compiler
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Introduction to C++
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> C++ based software and application
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Programs without classes and objects
                </li>
                <li id="what-will-learn-content">
                    <span id="tick"><i class="fa fa-check"></i> </span> Introduction to classes and objects with real life time examples
                </li>
                <div id="accordion">
                    <div class="collap">
                        ...
                        <div id="collapseOne" class="collapse" data-parent="#accordion">
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Functions in C++
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Functions-intro to private and public with real time examples
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Function Overloading
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Operators in C++ and Operator Overloading
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Static variables
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Use of  default parameters 
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Pass by address/ Pass by value
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Friend Function
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Inline function and <b>This</b> Keyword
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Scope resolution Operator 
                            </li>
                            <li id="what-will-learn-content">
                                <span id="tick"><i class="fa fa-check"></i> </span> Files in C++ and File Handling.
                            </li>
                        </div>
                    </div>
                </div>
    ...
    <div class="overlay" id="overlay">
        ...
        <div class="overlaycontainer">
            <video id="video" controls>
                    <source src="../../videos/Introduction to C++ -- EngiGyan.mp4" type="video/mp4">
